        ...
        <Box >
            ...
            <Box >
                <HStack mt="40px" gap="30px" >
                    <VStack className='card' boxShadow= "rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px" width="40%" >
            ...
            <Button onClick={handleTour} className='btn' p="10px 50px 10px 50px" color="white" backgroundColor="#608188" mt="80px">ALL TOURS</Button>
        </Box>
    </Center>
  )
}
